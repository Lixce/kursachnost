(function () {
  ...
  var modalRiotLogin = document.getElementById("modalRiotLogin");
  ...
  document.querySelectorAll("[data-open-modal]").forEach(function (btn) {
    btn.addEventListener("click", function () {
      ...
      if (id === "register") openModal(modalRegister);
      else if (id === "riot-login") openModal(modalRiotLogin);
    });
  });
  ...
  document.querySelectorAll(".auth-form").forEach(function (formEl) {
  ...
  wireModalCancel(modalRegister);
  wireModalCancel(modalRiotLogin);

  if (btnRiotDemo) {
    btnRiotDemo.addEventListener("click", function () {
      openModal(modalRiotLogin);
    });
  }
